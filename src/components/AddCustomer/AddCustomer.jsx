    ...
    try {
      const response = await axios.post(
        "https://farmer-api-9a00.onrender.com/customers",
        {
          ...
          username: username,
          image:
            "https://images.unsplash.com/photo-1653055645302-d88b0abd4e99?q=80&w=1374&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
          email: email,
          remarks: remarks,
        },
        {
